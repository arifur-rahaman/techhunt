    ...
    <div>
      <footer className="footer p-10 bg-[#0D1B1B] text-white">
        ...
        <div>
          ...
          <ul>
            <li className="link link-hover">Frontend Development</li>
            <li className="link link-hover">Backend Development</li>
            <li className="link link-hover">Full-Stack Development</li>
            <li className="link link-hover">MERN Stack Development</li>
          </ul>
        </div>
        <div>
